...
import panel from "../../public/panelesCieloBonito.jpg"
export default function Ahorro() {
    return (
        <section className="relative h-[700px] md:h-[400px] w-full bg-sky-500 md:flex md:items-center md:justify-between">

            <Image
                src={panel}
                className="absolute h-[700px] md:h-[400px] w-full opacity-90 md:opacity-50 object-cover object-center md:object-right-top"
            />
